...
# Se importa la librería y se definde el modelo
from sklearn.ensemble import RandomForestClassifier  
RandomForest = RandomForestClassifier(n_estimators=50,random_state=9,n_jobs=-1) # Max_depth
RandomForest.fit(X_train, Y_train) 

# Se hace la predicción
Y_predict_1   = RandomForest.predict(X_test)

# Se imprimen los valores que fueron correctamente predecidos
matches_1 = (Y_predict_1 == Y_test) 
Acertados = matches_1.sum()

Total_d = len(matches_1)

print(f"Se acertaron {Acertados} de {Total_d} datos.")

# Test score (Precisión)
score_RandomForest = RandomForest.score(X_test, Y_test)
print(score_RandomForest)

"""Se obtuvo un score de 85%, y podemos ver que no tiene ni underfitting ni overfitting.

### Se procederá a hacer 5 validaciones por medio de Cross-Validation con K-Folds
"""
